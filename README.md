...
The project uses the Brazilian E-Commerce Public Dataset by Olist, which contains information related to customers, orders, order items, payments, products, sellers, reviews, and product categories. The dataset provides a real-world view of an e-commerce business and allows different aspects of the customer and order journey to be analyzed together.__
